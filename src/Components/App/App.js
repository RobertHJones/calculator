...
function App() {
  ...
  function calculateLBTT(price) {
    const firstRate = (250 - 145) / 50;
    const secondRate = (325 - 250) / 20 + firstRate;
    const thirdRate = (750 - 325) / 10 + secondRate;
    ...
    const lowestBand = (newPrice - 145) / 50;
    // houses priced £250k-£325k
    const bandTwo = (newPrice - 250) / 20 + firstRate;
    // houses priced £325k-£750k
    const bandThree = (newPrice - 325) / 10 + secondRate;
    // houses priced above £750k
    const topBand = (newPrice - 750) * 0.12 + thirdRate;
